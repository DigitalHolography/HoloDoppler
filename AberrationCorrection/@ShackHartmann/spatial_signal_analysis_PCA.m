...
sub_images = zeros(subAp_numX, subAp_numX, obj.n_SubAp ^ 2);

FH_4D = ones(subAp_numX, subAp_numY, batch_size, n_subAp_x * n_subAp_y) + 1i * ones(subAp_numX, subAp_numY, batch_size, n_subAp_x * n_subAp_y);
