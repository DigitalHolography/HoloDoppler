...
% create pinhole mask
pinhole_mask = construct_mask(0, 4, SubAp_numY, SubAp_numX);
...
FH_reduced = ones((obj.n_SubAp) ^ 2, floor(ac.numX / obj.n_SubAp), floor(ac.numX / obj.n_SubAp), size(FH, 3));
FH_reduced_bis = ones((obj.n_SubAp) ^ 2, floor(ac.numX / obj.n_SubAp), floor(ac.numX / obj.n_SubAp));
