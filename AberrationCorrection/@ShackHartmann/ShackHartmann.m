...
methods
    ...
    [shifts, StitchedMomentsInSubApertures, StitchedCorrInSubApertures, FH] = compute_images_shifts(obj, FH, f1, f2, gw, calibration, enable_svd, svdThreshold, acquisition)
