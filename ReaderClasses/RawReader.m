...
classdef RawReader
    ...
    methods
        ...
        function obj = RawReader(path, endianness, acquisition, ...
            ...
            final_frame_size = max(acquisition.numX, acquisition.numY);
            obj.true_frame_width = acquisition.numX;
            obj.true_frame_height = acquisition.numY;

            obj.acquisition.numX = final_frame_size;
            obj.acquisition.numY = final_frame_size;

            %% construct offsets
            n_frames = obj.num_frames();
            num_batches = floor((n_frames - obj.j_win) / obj.j_step);
            pix_per_image = obj.acquisition.numX * obj.acquisition.numY;
        ...
        function batch = read_batch(obj, k)
            ...
            batch = zeros(ac.numX, ac.numY, obj.j_win, 'single');
            fd = fopen(obj.path, 'r');
        ...
        function batch = read_frame_batch(obj, batch_size, frame_offset)
            ...
            batch = zeros(ac.numX, ac.numY, batch_size, 'single');
        ...
        function width = get_frame_width(obj)
            width = obj.acquisition.numX;
        end

        function height = get_frame_height(obj)
            height = obj.acquisition.numY;
        end
