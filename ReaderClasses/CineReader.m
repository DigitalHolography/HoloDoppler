        ...
        function frame_batch = read_frame_batch(obj, batch_size, frame_offset)
            ...
            if obj.is_packed
                ...
                for i = 1:batch_size
                    ...
                    if obj.bi_compression == 256 % packed frame contains numX*numY u10 or numX*numY*5/4 Bytes
                        packed_frame_size = ceil(obj.true_frame_width * obj.true_frame_height / 4) * 5;
                    elseif obj.bi_compression == 1024 % packed frame contains numX*numY u12 or numX*numY*3/2 Bytes
