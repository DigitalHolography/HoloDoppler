classdef CineReader
    ...
    properties
        ...
        true_frame_width
        true_frame_height
        rephasing_data % AberrationCorrectionClass from previous acquisition
    end
    ...
    methods
        ...
        %                        obj.rephasing_data.aberration_correction.generateZernikes(obj.frame_width, obj.frame_height);
        %
        %            for j = jstart:jstop
        %               % load phase
