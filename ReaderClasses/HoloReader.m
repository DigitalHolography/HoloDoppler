classdef HoloReader
    ...
    methods
        ...
        function frame_batch = read_frame_batch(obj, batch_size, frame_offset)
            ...
            frame_batch = zeros(obj.frame_height, obj.frame_width, batch_size, 'single');
            ...
            for i = 1:batch_size
                ...
                if obj.bit_depth == 8
                    frame_batch(height_range, width_range, i) = reshape(fread(fd, obj.frame_width * obj.frame_height, 'uint8=>single', endian), obj.frame_height, obj.frame_width);
                elseif obj.bit_depth == 16
                    frame_batch(height_range, width_range, i) = reshape(fread(fd, obj.frame_width * obj.frame_height, 'uint16=>single', endian), obj.frame_height, obj.frame_width);
                end
        ...
        function frame_batches = read_all_frames(obj, batch_size, batch_stride)
            ...
            frame_batches = zeros(obj.frame_height, obj.frame_width, batch_size, num_batches);
