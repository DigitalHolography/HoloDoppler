...
hold on;
area(axis_x(range_1), signal(range_1), 'EdgeColor', 'black', 'FaceColor', [0.9 0.9 0.9], 'LineWidth', 1, 'DisplayName', 'Arteries');
area(axis_x(range_2), signal(range_2), 'EdgeColor', 'black', 'FaceColor', [0.9 0.9 0.9], 'LineWidth', 1, 'DisplayName', 'Arteries');
p_mask = plot(axis_x, signal, 'black', 'LineWidth', 1, 'DisplayName', 'Arteries');
% hold on;
% Noise_Freq = 1.16; %kHz
% NT = size(SH,3);
%
