...
HF_energy = squeeze(sum(SH(:, :, n1:ni), 3)) + squeeze(sum(SH(:, :, nj:n4), 3));
LF_energy = squeeze(sum(SH(:, :, ni:n2), 3)) + squeeze(sum(SH(:, :, n3:nj), 3));
total_energy = squeeze(sum(SH(:, :, n1:n2), 3)) + squeeze(sum(SH(:, :, n3:n4), 3));
