...
parfor (batch_idx = 1:num_batches, parfor_arg)
    ...
    % computation
    shack_hartmann = ShackHartmann(num_subapertures, num_subapertures_inter, p, calibration_factor, subaperture_margin, corrmap_margin, power_filter_corrector, sigma_filter_corrector, size(FH, 1), size(FH, 1));
