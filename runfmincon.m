function opt = runfmincon(x0,objfun,amin,amax)
...
% problem.options.OptimalityTolerance = 1e-04;
...
PSoptions.MeshTolerance = 1e-1;
[x,Fps] = patternsearch(objfun,x0,[],[],[],[],amin,amax,PSoptions);
