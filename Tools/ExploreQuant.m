...
methods
    ...
    function updateAverageImage(obj)
        ...
        obj.avgImage = moment0(abs(obj.SH), obj.Params.frequencyRange(1), obj.Params.frequencyRange(2), obj.Params.fs, size(obj.SH, 3), 0);
    end
    ...
    function calc_velocity(obj)
        ...
        M0 = moment0(abs(miniSH), obj.Params.frequencyRange(1), obj.Params.frequencyRange(2), obj.Params.fs, size(obj.SH, 3));
        M2 = moment2(abs(miniSH), obj.Params.frequencyRange(1), obj.Params.frequencyRange(2), obj.Params.fs, size(obj.SH, 3));
        %f_ = sqrt(M2./M0);
        f_ = sqrt(M2 ./ mean(M0, [1, 2]));
        M0_bkg = moment0(abs(miniSH .* minibkg), obj.Params.frequencyRange(1), obj.Params.frequencyRange(2), obj.Params.fs, size(obj.SH, 3));
        M2_bkg = moment2(abs(miniSH .* minibkg), obj.Params.frequencyRange(1), obj.Params.frequencyRange(2), obj.Params.fs, size(obj.SH, 3));
    ...
    function spectrum_plotting(obj, rescale)
        ...
        obj.updateMasks();
        xline(obj.Params.frequencyRange(1), '--')
        xline(obj.Params.frequencyRange(2), '--')
        xline(-obj.Params.frequencyRange(1), '--')
        xline(-obj.Params.frequencyRange(2), '--')
        xticks([-obj.Params.frequencyRange(2) -obj.Params.frequencyRange(1) 0 obj.Params.frequencyRange(1) obj.Params.frequencyRange(2)])
        xticklabels({num2str(round(-obj.Params.frequencyRange(2), 1)), num2str(round(-obj.Params.frequencyRange(1), 1)), '0', num2str(round(obj.Params.frequencyRange(1), 1)), num2str(round(obj.Params.frequencyRange(2), 1))})
        ...
        momentM0 = moment0(obj.SH, obj.Params.frequencyRange(1), obj.Params.frequencyRange(2), obj.Params.fs, size(SH_mask, 3));
        momentM1 = moment1(obj.SH, obj.Params.frequencyRange(1), obj.Params.frequencyRange(2), obj.Params.fs, size(SH_mask, 3));
        momentM2 = moment2(obj.SH, obj.Params.frequencyRange(1), obj.Params.frequencyRange(2), obj.Params.fs, size(SH_mask, 3));
        ...
        sclingrange = abs(fftshift(axis_x)) > obj.Params.frequencyRange(1);
