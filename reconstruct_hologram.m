function [hologram0, sqrt_hologram0] = reconstruct_hologram(FH, acquisition, gaussian_width, use_gpu, svd, svd_threshold, svdx, Nb_SubAp, phase_correction, time_transform, spatial_transformation)
