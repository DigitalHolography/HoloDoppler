...
# ------------------------------------------------------------------
@track_time("_process_shack_hartmann")
...
# ------------------------------------------------------------------
@track_time("preview_process_moments")
...
@track_time("_process_gpu_streaming")
...
@track_time("_process_gpu_streaming_onram_multistream")
