...
r2_retina = 15;
mask_blur_retina = 1;
retina_mask_centered = make_ring_mask(numX, numY, r1_retina, r2_retina);
...
x_neighborhood = 0;
y_neighborhood = 0;
iris_mask_centered = make_ring_mask(numX, numY, r1_iris, r2_iris);
...
for id_y = 1:y_stride:numY %
    ii_y = ii_y + 1;
    ii_x = 0;
    % Update waitbar and message
    waitbar(id_y / numY, ['compute image ', num2str(id_y / numY * 100), ' percent']);

    for id_x = 1:x_stride:numX %
        ii_x = ii_x + 1;
