...
REFERENCE_PATH = Path(r"F:\ZAC\260113_AUZ0752_5_HD_1\raw\260113_AUZ0752_5_HD_1_output.h5") # from matlab compute
...
test_path = HOLO_FILEPATH.parent / target_dir_name / f"{target_dir_name}_HD" / "h5" / f"{target_dir_name}_HD_output.h5"
...
with h5py.File(test_path, "r") as f_test, h5py.File(REFERENCE_PATH, "r") as f_ref:
    ...
    ref_data = np.flip(np.permute_dims(ref_data, (0, 2, 1)), axis=2)  # Adjust dimensions to match test_data
