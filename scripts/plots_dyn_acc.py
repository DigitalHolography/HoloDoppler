...
Features:
    ...
    - optional secondary *_2 registration CSV plotted behind the primary CSV
...
def generate_plots(
    ...
    csv_path_2 = find_secondary_registration_file(
    ...
    if csv_path_2 is not None:
        ...
        registration_2 = load_registration_csv(csv_path_2)

        print(f"Reading secondary registration CSV: {csv_path_2}")
    ...
    if n_csv_2 is not None:

        print(

            f"  translation (_2)    : {n_csv_2}"
    ...
    if n_csv_2 is not None and n_csv_2 != n_moment0:

        raise ValueError(

            "\nSecondary registration CSV length does not match:\n"

            f"  HDF5 / primary signals = {n_moment0}\n"

            f"  Secondary CSV (_2)     = {n_csv_2}\n"

            "\n"

            "The primary and secondary registration signals must "
    ...
    if registration_2 is not None:
        ...
        translation_x_2 = registration_2["translation_x_px"]

        translation_y_2 = registration_2["translation_y_px"]

        rotation_2 = registration_2["rotation_deg"]

        scale_2 = registration_2["scale"]
