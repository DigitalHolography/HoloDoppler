...
if __name__ == "__main__":
    # Load data
    with h5py.File(
        r"D:\PROJETS\DATA\260113_AUZ0752_6_HD_2\raw\260113_AUZ0752_6_HD_2_output.h5",
        "r",
    ) as f:
        m0 = f["moment0"][()]
        nt, ny, nx = m0.shape
        ...
        np.savez("svd_results.npz", U=U_r, S=S_r, V=Vt, time_coeffs=time_coeffs)
