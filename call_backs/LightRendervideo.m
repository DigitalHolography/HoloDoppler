...
registration_disk = app.cache.registration_disk;
registration_disk_ratio = app.cache.registration_disk_ratio;
...
switch output_video
    case 'power_Doppler'
        return
    case 'moments'
        video_M0 = zeros(app.numX, app.numY, 1, local_num_batches, 'single');
