function GPUpreview = check_GPU_for_render(app)
...
predicted_FH_size = size(app.frame_batch, 1) * size(app.frame_batch, 2) * size(app.frame_batch, 3) * 8; % in bytes with single complex FH
