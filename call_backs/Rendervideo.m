...
for batch_idx = 1:numBatches
    ...
    switch output_video
        ...
        case 'choroid'
            ...
            video_moment1(:, :, :, batch_idx) = image_type_list_par.moment_1.image;
            video_moment2(:, :, :, batch_idx) = image_type_list_par.moment_2.image;
            images_choroid_0(:, :, :, batch_idx, :) = rescale(image_type_list_par.choroid.parameters.intervals_0);
            images_choroid_1(:, :, :, batch_idx, :) = rescake(image_type_list_par.choroid.parameters.intervals_1);
