...
app.var_ImageTypeList.construct_image(app.FH, app.cache.wavelength, acquisition, app.blur, use_gpu, app.SVDCheckBox.Value, app.SVDTresholdCheckBox.Value,...
    app.SVDxCheckBox.Value, app.SVDTresholdEditField_2.Value, app.SVDx_SubApEditField.Value, [], app.compositef1EditField.Value, app.compositef2EditField.Value, app.compositef3EditField.Value, is_low_frequency, app.spatialTransformationDropDown.Value, app.time_transform, app.SubAp_PCA, app.xystrideEditField.Value, app.unitcellsinlatticeEditField.Value, app.r1EditField.Value, ...
