...
predicted_FH_size = size(app.frame_batch, 1) * size(app.frame_batch, 2) * size(app.frame_batch, 3) * 16; % 8/16 for single/double complex scalars
% FIXME: 0.7
if predicted_FH_size > 0.7 * available_mem
    GPUpreview = false;
end
