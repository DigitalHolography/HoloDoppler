...
methods (Access = private)
    ...
    function LoadfileButtonPushed(app, ~)
        ...
        try
            app.file_loaded_lamp.Color = [1 0.5 0]; %
            ...
            app.file_loaded = 1;
            app.file_loaded_lamp.Color = [0 1 0]; %
        catch ME
            % Display error message and line number
            MEdisp(ME);
            app.file_loaded_lamp.Color = [1 0 0];
            drawnow
        end
    ...
    function VideoRenderingButtonPushed(app, ~)
        app.VideoRenderingLamp.Color = [1 0.5 0]; drawnow; % orange in process
    ...
    function FoldermanagementButtonPushed(app, ~)
        ...
        function render(~, ~)
            % Render the videos in the drawer list with their config files if they exist

            file_list = cell(size(app.HD.drawer_list), 2); % preallocate file_list with the same size as drawer_list
            ...
            for i = 1:length(file_list) % Circles through the files with their config files

                file = file_list{i};

                if (~isempty(file{2})) % If there are config files for the given file

                    for j = 1:length(file{2}) % Circles through the config files for the given file
                        file_config = file{2}{j};
                        app.HD.LoadFile(file{1}, params = file_config{j});
                        app.HD.VideoRendering();
                    end
        ...
        function del_configs(~, ~)
            % Delete the config files of the videos in the drawer list
    ...
    % Callback function: AutofocusFromRef, CalibrationFactorEditField,
    % ...and 48 other components
    function refreshClass(app, ~)
        guitoclass(app.HD, app);

        switch app.time_transform.Value
            case 'FFT'
                app.time_range1.Enable = true;
                app.time_range2.Enable = true;
                app.frequency_rangeLabel.Enable = true;
                app.index_range1.Enable = false;
                app.index_range2.Enable = false;
                app.index_rangeLabel.Enable = false;
            case 'PCA'
                app.time_range1.Enable = false;
                app.time_range2.Enable = false;
                app.frequency_rangeLabel.Enable = false;
                app.index_range1.Enable = true;
                app.index_range2.Enable = true;
                app.index_rangeLabel.Enable = true;
            case 'ICA'
                app.time_range1.Enable = false;
                app.time_range2.Enable = false;
                app.frequency_rangeLabel.Enable = false;
        ...
        if app.svdx_filter.Value
            app.svdx_threshold.Enable = true;
            app.NsubxLabel.Enable = true;
            app.svdx_Nsub.Enable = true;
        else
            app.svdx_threshold.Enable = false;
            app.NsubxLabel.Enable = false;
            app.svdx_Nsub.Enable = false;
        end

        if app.svdx_t_filter.Value
            app.svdx_t_threshold.Enable = true;
            app.NsubxtLabel.Enable = true;
            app.svdx_t_Nsub.Enable = true;
        else
            app.svdx_t_threshold.Enable = false;
            app.NsubxtLabel.Enable = false;
            app.svdx_t_Nsub.Enable = false;
        end
    ...
    function RenderPreviewButtonPushed(app, ~)
        ...
        app.RenderPreviewLamp.Color = [1 0.5 0]; % orange in process
        drawnow; % red in process
...
methods (Access = private)
    ...
    function createComponents(app)
        ...
        app.FileselectionPanel.BorderType = 'etchedin';
        ...
        app.BatchselectionparametersandVideoRenderingPanel.BorderType = 'etchedin';
        ...
        % Create AutofocusFromRef
        app.AutofocusFromRef = uicheckbox(app.BatchselectionparametersandVideoRenderingPanel);
        ...
        app.CurrentFilePanel.BorderType = 'etchedin';
        ...
        app.AdvancedProcessingPanel.BorderType = 'etchedin';
        ...
        app.AberrationcompensationPanel.BorderType = 'etchedin';
        ...
        % Create IterativeCheckBox
        app.IterativeCheckBox = uicheckbox(app.AberrationcompensationPanel);
        ...
        % Create numberofiterationLabel
        app.numberofiterationLabel = uilabel(app.AberrationcompensationPanel);
        ...
        % Create NumberOfIterationEditField
        app.NumberOfIterationEditField = uieditfield(app.AberrationcompensationPanel, 'numeric');
        ...
        % Create calibrationfactorLabel
        app.calibrationfactorLabel = uilabel(app.AberrationcompensationPanel);
        ...
        % Create CalibrationFactorEditField
        app.CalibrationFactorEditField = uieditfield(app.AberrationcompensationPanel, 'numeric');
        ...
        % Create calibrationfactorLabel_2
        app.calibrationfactorLabel_2 = uilabel(app.AberrationcompensationPanel);
        ...
        % Create ConvergenceThreshold
        app.ConvergenceThreshold = uieditfield(app.AberrationcompensationPanel, 'numeric');
        ...
        % Create onlydefocusCheckBox
        app.onlydefocusCheckBox = uicheckbox(app.AberrationcompensationPanel);
        ...
        app.AutofocusButton = uibutton(app.RenderingparametersPanel, 'push');
        ...
        % Create PaddNLabel
        app.PaddNLabel = uilabel(app.RenderingparametersPanel);
        ...
        % Create Padding_num
        app.Padding_num = uieditfield(app.RenderingparametersPanel, 'numeric');
