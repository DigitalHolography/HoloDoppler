classdef OutputTypeList2 < handle
    
    % output types from the rendering pipeline
    properties
        power_Doppler
        power_1_Doppler
        power_2_Doppler
    ...
    methods
        ...
        function obj = OutputTypeList2()
            ...
            obj.spectrogram = GraphType('spectrogram');
            obj.broadening = GraphType('broadening');
            obj.SH = ImageType('SH', struct('vector', [], 'SH', []));
            obj.autocorrelogram = GraphType('autocorrelogram');
            ...
            obj.SVD_U = MultipleImagesType('SVD_U');
        ...
        function clear(obj, varargin)
            ...
            if nargin == 1
                % If no input is specified then all outputs are cleared
        ...
        function construct_image(obj,Params, SHin, covin, Uin)
